...
exports.graphicalItemIdentity = graphicalItemIdentity;
/**
 * @fileOverview
 ...
 */
function graphicalItemIdentity(item, themeCount) {
  ...
  var keyString = String(item.dataKey);
  var hashResult = computeHash(keyString);
  if (themeCount != null && themeCount > 0) {
