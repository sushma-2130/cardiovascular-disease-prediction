...
export declare const setChartData: import("@reduxjs/toolkit").ActionCreatorWithOptionalPayload<ChartData<unknown> | undefined, "chartData/setChartData">, setDataStartEndIndexes: import("@reduxjs/toolkit").ActionCreatorWithPayload<Partial<BrushStartEndIndex>, "chartData/setDataStartEndIndexes">, setComputedData: import("@reduxjs/toolkit").ActionCreatorWithNonInferrablePayload<"chartData/setComputedData">;
